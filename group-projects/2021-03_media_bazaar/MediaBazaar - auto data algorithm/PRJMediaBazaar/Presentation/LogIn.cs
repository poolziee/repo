    ...
    partial class LogIn : Form
    {
        ...
        private void btnLogIn_Click(object sender, EventArgs e)
        {
            ...
            //{
                ...
                {
                ScheduleControl sc = new ScheduleControl(emp);
                PRJMediaBazaar.Presentation.StartupForm.employees = emp.Employees.ToList();
                PRJMediaBazaar.Presentation.StartupForm.days = new List<Day>();
                Schedule[] schedules = sc.Schedules;
                foreach (Schedule s in schedules)
                {
                    PRJMediaBazaar.Presentation.StartupForm.days.AddRange(s.Days.ToArray());
                }
